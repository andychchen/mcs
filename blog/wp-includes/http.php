...
class WP_Http {
	 ...
	 *
	 * There are currently issues with "michiganchineseschool.netfirmsmysql.com" not resolving correctly with
	...
	function request( $url, $args = array() ) {
		...
		$r['local'] = $homeURL['host'] == $arrURL['host'] || 'michiganchineseschool.netfirmsmysql.com' == $arrURL['host'];
		unset($homeURL);
...
class WP_Http_Fsockopen {
	...
	function request($url, $args = array()) {
		...
		//fsockopen has issues with 'michiganchineseschool.netfirmsmysql.com' with IPv6 with certain versions of PHP, It attempts to connect to ::1,
