...
if (is_category($cat_id) || in_category($cat_id) || $in_subcategory_blogs ) 
            ...
            <div id="albums">
                <div class="container_16">
                    ...
                    <div class="grid_4 <?php echo 'trim trim-' . $counter; if ($counter == 1) { echo ' alpha'; } elseif ($counter == 4) { echo ' omega'; $counter = 0; } ?>">
                        ...
                        <div class="post-image-block"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php woo_get_image('image','220','150'); ?></a></div>
