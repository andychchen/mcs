...
<?php //	This theme is licensed under CC3.0, you are not allowed to modify/remove the script and link without permission.?>
					<a href="http://www.templatelite.com/">Wordpress Templates</a> Presented by <a href="http://www.webhostingreport.com/">Best Web Hosting</a> and <a href="http://www.vendita-affitti.it/">Case</a><?php echo templatelite_show_links();?>
				<?php wp_footer(); ?>
			</div>
		</div></div>
	</div></div>	
