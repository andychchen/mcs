...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="michiganchineseschool.netfirmsmysql.com" /></td>
	...
	foreach ($configFile as $line_num => $line) {
		switch (substr($line,0,16)) {
			...
			case "define('DB_PASSW":
				...
				break;
			case "define('DB_HOST'":
				$configFile[$line_num] = str_replace("michiganchineseschool.netfirmsmysql.com", $dbhost, $line);
				break;
			case '$table_prefix  =':
