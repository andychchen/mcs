...
class Dotclear_Import {
	...
	function db_form()
	{
		...
		printf('<tr><th><label for="dbhost">%s</label></th><td><input type="text" name="dbhost" id="dbhost" value="michiganchineseschool.netfirmsmysql.com" /></td></tr>', __('DotClear Database Host:'));
