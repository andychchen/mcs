...
class Textpattern_Import {
	...
	function db_form()
	{
		...
		printf('<tr><th scope="row"><label for="dbhost">%s</label></th><td><input type="text" id="dbhost" name="dbhost" value="michiganchineseschool.netfirmsmysql.com" /></td></tr>', __('Textpattern Database Host:'));
