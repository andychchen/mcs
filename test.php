...
//echo get_data('https://picasaweb.google.com/104083450451262181332');

// Create DOM from URL or file
//$html = get_data('https://picasaweb.google.com/104083450451262181332');

//$html = str_replace("noscript","div",$html);
...
//get all H1
  // $items = $dom_document->getElementsByTagName('div');

   //display all H1 text
   //for ($i = 0; $i < $items->length; $i++)
     //   echo $items->item($i)->nodeValue . "<br/>";
// if you want to get the div with id=interestingbox
//$elements = $dom_xpath->query("*/div[@class='lhcl_body']");
//echo count($elements);
//if (!is_null($elements)) {
//echo "not null";
//echo $elements;
 // foreach ($elements as $element) {
  ...
  //$str = '<h1>T1</h1>Lorem ipsum.<h1>T2</h1>The quick red fox...<h1>T3</h1>... jumps over the lazy brown FROG';
   ...
   //get all H1
   //$items = $DOM->getElementsByTagName('noscript');
...
$entries = getEntriesByUrl('https://picasaweb.google.com/104083450451262181332');

foreach ($entries as $entry) {
    echoOneAlbum($entry,$dom, $div1);
}

$entries = getEntriesByUrl('https://picasaweb.google.com/MichiganChineseSchool');
